...
export const ChatbotMessageCard = ({ value }: Props) => {
	return (
		<Card
			className={`flex flex-col gap-4 h-fit w-full bg-gray-50 dark:bg-gray-950 border border-gray-400 dark:border-gray-600 ${value.role === MessageRole.USER ? "bg-emerald-300" : ""}`}
		>
			<CardContent
				className={
