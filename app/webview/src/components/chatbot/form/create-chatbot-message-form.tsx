    ...
    return (
        <form action={formAction}>
            ...
            <div className={'flex gap-1.5'}>
                <Select key={state.meta.llm} name={'meta.llm'} defaultValue={state.meta.llm}>
                ...
                <Select key={state.meta.mode} name={'meta.mode'} defaultValue={state.meta.mode}>
                    <SelectTrigger className="w-[180px]">
            ...
            <Input type={'hidden'} key={state.chatbotId} name='chatbotId' defaultValue={state.chatbotId}/>
